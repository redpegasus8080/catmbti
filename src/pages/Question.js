...
const Question = () => {
    ...
    return (
        <Wrapper>
            ...
            <Title>{QuestionData[1].title}</Title>
            <ButtonGroup>
                <Button style={{ width: "40%", minHeight: "200px", fontSize: "15pt" }}>{QuestionData[1].answera}</Button>
                <Button style={{ width: "40%", minHeight: "200px", fontSize: "15pt", marginLeft: "20px" }}>{QuestionData[1].answerb}</Button>
            </ButtonGroup>
        </Wrapper>
    )
}
